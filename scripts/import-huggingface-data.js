...
import { HuggingFaceDatasetService } from '../lib/huggingface-dataset-service.js'
...
async function main() {
  ...
  try {
    ...
    const [menProducts, womenProducts, allProducts] = await Promise.all([
      HuggingFaceDatasetService.fetchProductsByGender('Men', 100),
      HuggingFaceDatasetService.fetchProductsByGender('Women', 100),
      HuggingFaceDatasetService.getAllProducts(300)
    ])
